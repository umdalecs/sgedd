            ...
            <div className="h-2/3 bg-primary flex justify-between px-5 py-3">
                <div className="flex w-1/6 min-w-[175px] gap-4 items-center">
                    <div className="bg-primary-foreground w-2/3 rounded-2xl flex items-center justify-center">
                        <Image src={"/img/logo-sgedd.jpg"} alt="SGEDD" width={100} height={100}></Image>
                    </div>
                ...
                <div className="flex items-center justify-end gap-2 flex-wrap ">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-64 bg-sidebar-border space-y-2">
                            <DropdownMenuLabel>Notificaciones</DropdownMenuLabel>
                            <DropdownMenuSeparator className="bg-accent-foreground" />

                            {notificaciones.length > 0 ? (
                                notificaciones.map((n) => (
                                <DropdownMenuItem className="bg-primary-foreground rounded-2xl border-b-3 border-b-primary" key={n.id}>
                                    {n.texto}
                                </DropdownMenuItem>
                                ))
                            ) : (
                            ...
                            <DropdownMenuItem className="bg-primary rounded-lg justify-center">
                                <p className="text-sidebar-primary-foreground font-bold">Ver todas</p>
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                    <DropdownMenu>
