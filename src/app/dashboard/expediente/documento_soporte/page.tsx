            ...
            <div className="max-w-5xl mx-auto mt-18 bg-background rounded-2xl shadow-lg overflow-hidden">
                <div className="bg-primary text-white p-4 flex items-center space-x-2">
                    <h1 className="text-lg font-semibold"> 
                        Reportar error en documento
                    </h1>
                </div>
                <div className="p-6 grid gap-6">
                    <div className="grid gap-1.5">
                        <Label htmlFor="documento" className="text-sm font-medium text-gray-600">
                        Documento
                        </Label>
                    ...
                    <div className="grid gap-1.5">
                        <Label htmlFor="mensaje" className="text-sm font-medium text-gray-600">
                        Mensaje
                        </Label>
                        <Textarea 
                    ...
                    <div className="p-6 pt-0">
                        <Button type="submit" className="w-full bg-primary hover:bg-primary/70 rounded-xl">
                            Enviar Mensaje
                        </Button>
                    </div>
                </div>
